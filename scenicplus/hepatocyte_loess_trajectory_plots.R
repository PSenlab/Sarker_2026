...
cat("Gene matrix:", dim(gene_mat)[1], "ages x", dim(gene_mat)[2], "TFs\n")
cat("Region matrix:", dim(region_mat)[1], "ages x", dim(region_mat)[2], "TFs\n")
...
# Transpose: TFs as rows x Ages as columns
z_gene <- t(z_gene)
z_region <- t(z_region)

cat("[OK] Z-scoring complete. Shape:", dim(z_gene)[1], "TFs x", dim(z_gene)[2], "ages\n\n")
...
cat("[OK] Long format:", nrow(rss_long), "rows,", 
...
cat("[OK] Saved: male_tf_trajectories_gene.pdf\n")
...
cat("[OK] Saved: male_tf_trajectories_region.pdf\n")
...
cat("[OK] Saved: male_gene_region_overlay.pdf\n")
...
cat("[OK] Saved: male_cluster_means.pdf\n")
...
cat("[OK] Saved: male_cluster_means_labeled.pdf\n")
...
cat("[OK] Saved: male_cluster_summary.csv\n")
...
cat("[OK] Saved: female_tf_trajectories_gene.pdf\n")
...
cat("[OK] Saved: female_tf_trajectories_region.pdf\n")
...
cat("[OK] Saved: female_gene_region_overlay.pdf\n")
...
cat("[OK] Saved: female_cluster_means.pdf\n")
...
ggsave("female_cluster_means_labeled.pdf", plot = p5, 
       width = N_CLUSTERS * 6.5, height = 8, device = cairo_pdf)
cat("[OK] Saved: female_cluster_means_labeled.pdf\n")
...
cat("[OK] Saved: female_cluster_summary.csv\n")
