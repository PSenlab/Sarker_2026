...
print("✅ Saved: Heps_sex_horizontal.pdf")
...
print("✅ Saved: age_sex_dotplot.pdf")
...
print("✅ Saved: age_rss_gene_top30.pdf")
print("✅ Saved: age_rss_matrix_gene.csv")
...
print("✅ Saved: age_rss_region_top25.pdf")
print("✅ Saved: age_rss_matrix_region.csv")
...
print("✅ Saved: age_sex_rss_gene_top30.pdf")
print("✅ Saved: age_sex_rss_matrix_gene.csv")
...
print("✅ Saved: age_sex_rss_region_top25.pdf")
print("✅ Saved: age_sex_rss_matrix_region.csv")
...
print(f"✅ {len(common)} regulons overlap between RSS + AUC (gene & region)")
...
if len(common) > 0:
    ...
    plt.show()
    print("✅ Saved: combined_correlation_gene_vs_region_diamond.pdf")
else:
    print("⚠️ No overlapping regulons found for correlation plot")
...
print(f"✅ Found {len(hvr)} highly variable regions")
...
def plot_module_network(
    ...
    if len(subset_eRegulons) == 0:
        print(f"⚠️ No eRegulons found for module: {module_name}")
        return None
    ...
    try:
        nx_tables = create_nx_tables(
            ...
            subset_eRegulons=subset_eRegulons,  # ✅ FIXED: variable, not "subset_eRegulons"
            subset_regions=None,
    ...
    if nx_tables['Node']['TF'].empty:
        print(f"⚠️ No TF nodes found for module: {module_name}")
        return None
