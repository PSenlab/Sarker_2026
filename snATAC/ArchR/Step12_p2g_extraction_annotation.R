#!/usr/bin/env Rscript
# ==============================================================================
# Step 12: P2G Extraction, Clustering, and Annotation
# ==============================================================================
#
# Description:
#   This script extracts Peak-to-Gene (P2G) linkages from ArchR projects,
#   performs k-means clustering on P2G heatmaps, and annotates peaks using
#   ENCODE cCREs and ChIPseeker.
#
# Prerequisites:
...
# ==============================================================================
# 12.9: VISUALIZATION - CHIPSEEKER STACKED BARPLOT
# ==============================================================================
...
# High-contrast, publication-safe color palette
annotation_colors <- c(
...
# Calculate total peaks for label
...
# ==============================================================================
# 12.10: VISUALIZATION - ENCODE cCRE STACKED BARPLOT
# ==============================================================================
